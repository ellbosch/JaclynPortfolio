...
export const clients: Client[] = [
  ...
  { name: 'Best Buy', logo: '/images/logos/bestbuy.png' },
  { name: 'Arlo', logo: '/images/logos/arlo.png' },
  { name: 'Netgear', logo: '/images/logos/netgear.png' },
  { name: 'Nice', logo: '/images/logos/nice.png' },
  { name: 'Starkey', logo: '/images/logos/starkey.png' },
  ...
  { name: 'VC and Co', logo: '/images/logos/vcandco.png' },
];
