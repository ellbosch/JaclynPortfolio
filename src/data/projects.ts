...
Industrial Design: Dayne Tanner (Direction), Jack Marple (Lead)`,
    thumbnail: { src: '/images/projects/auraglow/01-led-light-on.webp', alt: 'Auraglow thumbnail' },
    images: [
      { src: '/images/projects/auraglow/01-led-light-on.webp', alt: 'Auraglow LED Light On' },
      { src: '/images/projects/auraglow/02-led-light-off.webp', alt: 'Auraglow LED Light Off' },
      { src: '/images/projects/auraglow/03-led-whitener-persp.webp', alt: 'Auraglow LED Whitener Perspective' },
      { src: '/images/projects/auraglow/04-led-whitener-closeup.webp', alt: 'Auraglow LED Whitener Closeup' },
      { src: '/images/projects/auraglow/05-case-open-lifestyle.webp', alt: 'Auraglow Case Open Lifestyle' },
      { src: '/images/projects/auraglow/06-complete-package.webp', alt: 'Auraglow Complete Package' },
      { src: '/images/projects/auraglow/07-plain-tray.webp', alt: 'Auraglow Plain Tray' },
      { src: '/images/projects/auraglow/08-whitening-strips-foil.webp', alt: 'Auraglow Whitening Strips Foil' },
      { src: '/images/projects/auraglow/09-whitening-strips-package.webp', alt: 'Auraglow Whitening Strips Package' },
      { src: '/images/projects/auraglow/10-whitening-strips-package-2.webp', alt: 'Auraglow Whitening Strips Package' },
      { src: '/images/projects/auraglow/11-whitening-tube-gel.webp', alt: 'Auraglow Whitening Tube and Gel' },
      { src: '/images/projects/auraglow/12-whitening-tube-closeup.webp', alt: 'Auraglow Whitening Tube Closeup' },
      { src: '/images/projects/auraglow/13-whitening-pen-front.webp', alt: 'Auraglow Whitening Pen Front' },
      { src: '/images/projects/auraglow/14-whitening-pen-uncapped.webp', alt: 'Auraglow Whitening Pen Uncapped' },
      { src: '/images/projects/auraglow/15-whitening-pen-lifestyle.webp', alt: 'Auraglow Whitening Pen Lifestyle' },
    ],
